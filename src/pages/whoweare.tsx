    ...
    leads: [
      {
        ...
        description: <>I'm a computer scientist who built the largest European deeptech meetup (15k members) and ended up investing as an angel in the sector. Some of my angel portfolio companies are now clocking £40m+ in revenue or part of national security contracts, but in deeptech that's still early days. In total I wrote 17 personal cheques including the likes of edge & GPU cloud leader <b><i><a href="https://ori.io">Ori Industries</a></i></b>, Quantum Photonics pioneer <b><i><a href="https://aegiq.com">Aegiq</a></i></b>, or holography world-leader <b><i><a href="https://www.vividq.com">Vivid-Q</a></i></b>.<br/><br/>
